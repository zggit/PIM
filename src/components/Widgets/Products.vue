						...
						<v-layout row wrap contact-item-info>
							<v-flex xs12 lg12 md12 sm-12 text-center>
								<div class="tab-image">
									...
									<!-- <v-radio-group v-model="details.selectedColor" row>
										<v-radio v-for="(item,i) in details.skus" color="primary" :label="item.color" :value="item.color" @change="selectProductBySku(details,item.sku_id)"  class="custome_radio"></v-radio>
									</v-radio-group> -->
									<div>
